...
public class MySQLiteHelper extends SQLiteOpenHelper {
  ...
  private static final String DATABASE_CREATE = "create table "
      + TABLE_MEETINGS + "(" + COLUMN_ID + " integer primary key autoincrement, " + COLUMN_GCM_REG_ID + " text not null, " + COLUMN_SUBJECT + " text not null, " + COLUMN_LOCATION  + " text not null, " +  COLUMN_DATE + " text not null, " + COLUMN_TIME + " text not null);";

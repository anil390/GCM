...
public class DisplayMyLocation extends FragmentActivity {
	  GoogleMap map;
	  ...
	  private static final LatLng APPLE = 
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.location_my_display);
	    ...
	    public boolean onOptionsItemSelected(MenuItem item) {
	        ...
	        case R.id.menu_lineconnecttwopoints:
	            ...
	            map.addPolyline(new PolylineOptions()
	                .add(GOLDEN_GATE_BRIDGE, APPLE).width(5).color(R.color.Red));
	            break;
	        }
	        return true;
	    }
